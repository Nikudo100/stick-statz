    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="relative flex items-center justify-center gap-6 lg:items-center lg:gap-8">
                        <div>
                            <img src="{{ asset('images/99354A0661C64DD0.jpeg') }}" alt="Image description">
                        </div>
                    </div>
                </main>
