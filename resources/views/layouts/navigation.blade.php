        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <a href="{{ route('stocks.show') }}" class="block px-3 py-6 text-black hover:bg-gray-200">
                        Остатки
                    </a>
                    <a href="{{ route('abc.index') }}" class="block px-3 py-6 text-black hover:bg-gray-200">
                        ABC
                    </a>
                    <a href="{{ route('turnover.index') }}" class="block px-3 py-6 text-black hover:bg-gray-200">
                        Обораиваемость
                    </a>
                    {{-- <a href="{{ route('abc.index') }}" class="block px-4 py-2 text-black hover:bg-gray-200">
                        ABC
                    </a> --}}
                    <div class="relative group px-3 py-6 dropdown">
                        <span
                        ...
                        <div class="dropdown-menu bg-white shadow-lg rounded-md mt-2">
                            <a href="{{ url('/clusters/all') }}" class="block px-4 py-2 text-black hover:bg-gray-200">
                                Все кластеры
                            </a>
                            <a href="{{ url('/clusters/main') }}" class="block px-4 py-2 text-black hover:bg-gray-200">
                                Общий кластер
                            </a>
